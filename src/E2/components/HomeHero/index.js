...
export default function HomeHero(props) {
    ...
    const handleSubmit = (e) => {
        ...
        handleNavigateWithParam('s', query.trim());
    };
            ...
            <form onSubmit={handleSubmit} className="mt-10 max-w-2xl mx-auto">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-32 py-4 text-lg border border-text-color/20 shadow focus:outline-none focus:ring-2 focus:ring-btn-hover-color focus:border-transparent focus:shadow-md rounded-xl placeholder:text-text-color/50"
                    />
                    <div className="absolute inset-y-0 right-0 flex items-center">
                        <button
                            type="submit"
                            className="inline-flex items-center justify-center gap-2 px-4 py-2 font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-btn-hover-color h-full rounded-r-xl"
                        >
                            {website.localize({
                                en: 'Search',
                                fr: 'Rechercher',
                    ...
                    <div className="mt-4 flex flex-wrap justify-center gap-2">
                        {category.items.map((topic) => (
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 px-4 py-2 font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 bg-btn-alt-color text-btn-alt-text-color hover:bg-btn-alt-hover-color hover:text-btn-alt-hover-text-color focus:ring-btn-alt-text-color rounded-xl"
                            >
                                {topic.name}
                            </button>
                        ))}
