...
export default function (props) {
    ...
    return (
        <div className={`${bgColor} pt-12`}>
            {title ? (
                <div
                    className={`flex mt-0 mb-6 ${
                        titlePosition === 'center'
                            ? 'justify-center'
                            : 'justify-start'
                    } text-2xl ${
                        titleSize === 'md' ? 'md:text-2xl' : 'md:text-4xl'
                    }`}
                >
                    <h2
                        className={`${sectionStyle} font-bold text-center md:text-left`}
                    >
                        {title}
                    </h2>
                </div>
            ...
            {description ? (
                <div
                    className={`flex mt-0 mb-4 justify-center text-lg ${
                        desPosition === 'center'
                            ? 'justify-center'
                            : 'justify-start'
                    }`}
