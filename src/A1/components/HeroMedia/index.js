...
import { Media, SafeHtml, Link } from '@uniwebcms/core-components';
            ...
            >
                ...
                >
                    <div
                        className={twJoin(
                            ...
                            alignmentV === 'center' && hasMediaContent
                    ...
                    >
                        {pretitle ? (
                            <SafeHtml
                                value={pretitle}
                                as="h2"
                                className="mb-3 text-lg lg:text-lg"
                            />
                        ) : null}
                        <SafeHtml
                            as="h1"
                        ...
                        {paragraphs?.length && paragraphs.filter(Boolean).length ? (
                            <SafeHtml
                                value={paragraphs}
                                className="mb-2 mt-4 lg:mt-6 xl:mt-8 text-base lg:text-lg"
                            />
                        ) : null}
                        {links?.length ? (
                            <div
                ...
                <div
                    className={twMerge(
                        ...
                        hasTextContent && hasMediaContent && alignmentH === 'right'
                            ? 'lg:mr-8'
                            : '',
