        ...
        case 'centered-card':
            content = (
                ...
                >
                    ...
                    <div
                        className={twJoin(
                            'relative z-10 w-full rounded-[var(--border-radius)] shadow-2xl overflow-hidden bg-primary-700'
                        )}
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-3 items-center">
                            {/* Left Side: Content */}
                            <div className="p-8 md:p-12 cols-span-1 lg:col-span-2">
                                <ContentBlock
                                    eyebrow={eyebrow}
                                    title={title}
                                    subtitle={subtitle}
                            ...
                            {sidePicture && (
                                <div className="relative w-full h-full min-h-[300px] hidden lg:block">
                                    <Image
                                        ...
                                        className="w-full h-full object-cover"
                                    />
                                    <div className="absolute inset-0 z-10 bg-primary-500/60" />
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    {backgroundImage && (
                        <div className="absolute inset-0">
                            <Image
                                ...
                                className="w-full h-full object-cover"
                            />
                            <div className="absolute inset-0 bg-bg-color/60"></div>
                        </div>
                    )}
                    <div
