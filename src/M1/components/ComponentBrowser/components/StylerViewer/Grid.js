...
export default function Grid(props) {
    ...
    return (
        <div className="w-full h-full">
            ...
            <div
                className={`max-h-[calc(100%-74px)] w-full mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-5 px-4 lg:px-6 pt-2 pb-4 overflow-auto`}
            >
                {components
                    .filter((key) => {
                        let flag = true;
